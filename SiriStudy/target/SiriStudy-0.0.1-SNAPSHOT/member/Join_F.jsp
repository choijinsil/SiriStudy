    ...
    <div class="col-md-6 col-md-offset-3">
      <form role="form" id="myform">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="userPw" name="userPw" placeholder="비밀번호" value="test">
        </div>
        <div class="form-group">
          <label for="userPwCheck">비밀번호 확인</label>
          <input type="password" class="form-control" id="userPwCheck" placeholder="비밀번호 확인" value="test">
